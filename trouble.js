/*
Changes made:
1. There were several typos made, so I fixed all of those (ex. getElementsById instead of getElementById)
2. Uncommented the Alert function and added quotes around the "equals" so that it would display properly.
*/
